...
#define SIG_DFL ((std::_CatcherPTR)0)   /* Default action   */
#define SIG_IGN ((std::_CatcherPTR)1)   /* Ignore action    */
#define SIG_ERR ((std::_CatcherPTR)-1)  /* Error return     */
#else
...
#ifdef __cplusplus
void (_USERENTRY * _RTLENTRY _EXPFUNC signal(int __sig, void (_USERENTRY * __func)(int))) (int);
}
#else
void (_USERENTRY * _RTLENTRY _EXPFUNC signal(int __sig, void (_USERENTRY * __func)())) (int);
#endif
