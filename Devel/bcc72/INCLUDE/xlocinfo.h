...
_C_LIB_DECL
 ...
 #if defined(__CODEGEARC__) || defined(__MWERKS__)
  #define _X_COLLATE	0
  #define _X_CTYPE		1
 ...
 #else	/* defined(__CODEGEARC__) etc. */
...
extern _CRTIMP2 float _Stof(const char *, char **, long);
extern _CRTIMP2 double _Stod(const char *, char **, long);
extern _CRTIMP2 long double _Stold(const char *, char **, long);
_END_C_LIB_DECL
_C_STD_END
#endif /* _XLOCINFO */
