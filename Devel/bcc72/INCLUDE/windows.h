...
#if defined(__BOROPT_A) && defined(__BOROPT_H)
...
#if defined(__CODEGEARC__) && defined(__cplusplus)
...
#ifndef RC_INVOKED
#if     ( _MSC_VER >= 800 ) || defined(__CODEGEARC__)
...
#if defined(__CODEGEARC__) && !defined(_WINSOCKAPI_) && !defined(_WINSOCK2API_)
#include <winsock2.h>
#endif /* __CODEGEARC__ */
#if defined(__CODEGEARC__) && !defined(_WINSOCKAPI_) && !defined(_MSWSOCK_)
#include <mswsock.h>
#endif /* __CODEGEARC__ */
#else
#if defined(__CODEGEARC__) && !defined(_WINSOCKAPI_) && !defined(_WINSOCK2API_)
