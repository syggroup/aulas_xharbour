...
int         _RTLENTRYF _EXPFUNC     chdir( const char _FAR *__path );
...
int         _RTLENTRYF _EXPFUNC     fnsplit(const char _FAR *__path,
                                    ...
                                    char _FAR *__name,
                                    char _FAR *__ext );
int         _RTLENTRY  _EXPFUNC     getcurdir( int __drive, char _FAR *__directory );
char _FAR * _RTLENTRY  _EXPFUNC     getcwd( char _FAR *__buf, int __buflen );
int         _RTLENTRY  _EXPFUNC     getdisk( void );
int         _RTLENTRY  _EXPFUNC     _mkdir( const char *__path );
char      * _RTLENTRY  _EXPFUNC     _mktemp( char *__template );
int         _RTLENTRY  _EXPFUNC     _rmdir( const char _FAR *__path );
char _FAR * _RTLENTRYF _EXPFUNC     searchpath( const char _FAR *__file );
int         _RTLENTRY  _EXPFUNC     setdisk( int __drive );

#if !defined(__STDC__)
int    _RTLENTRY _EXPFUNC   mkdir( const char *__path );
char * _RTLENTRY _EXPFUNC   mktemp( char *__template );
int    _RTLENTRY _EXPFUNC   rmdir( const char *__path );
#endif

int         _RTLENTRY  _EXPFUNC     _wchdir( const wchar_t *__path );
int         _RTLENTRY  _EXPFUNC     _wmkdir( const wchar_t *__path );
int         _RTLENTRY  _EXPFUNC     _wrmdir( const wchar_t *__path );
wchar_t   * _RTLENTRY  _EXPFUNC     wsearchpath( const wchar_t *__file );
