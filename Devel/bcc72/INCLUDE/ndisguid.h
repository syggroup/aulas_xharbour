...
// {1528D111-708A-4ca4-9215-C05771161CDA} - used with NDIS_WMI_PM_ADMIN_CONFIG
DEFINE_GUID(GUID_NDIS_PM_ADMIN_CONFIG,              0x1528d111, 0x708a, 0x4ca4, 0x92, 0x15, 0xc0, 0x57, 0x71, 0x16, 0x1c, 0xda);
// {B2CF76E3-B3AE-4394-A01F-338C9870E939} - use with NDIS_WMI_PM_ACTIVE_CAPABILITIES
...
DEFINE_GUID(GUID_NDIS_TCP_RSC_STATISTICS,           0x83104445, 0x9b5d, 0x4ee6, 0xa2, 0xa5, 0x2b, 0xd3, 0xfb, 0x3c, 0x36, 0xaf);

// {ece5360d-3291-4a6e-8044-00511fed27ee} - uses NDIS_PM_CAPABILITIES
DEFINE_GUID(GUID_PM_HARDWARE_CAPABILITIES,          0xece5360d, 0x3291, 0x4a6e, 0x80, 0x44, 0x00, 0x51, 0x1f, 0xed, 0x27, 0xee);
// {3ABDBD14-D44A-4a3f-9A63-A0A42A51B131} - uses NDIS_PM_CAPABILITIES
...
// {0C06C112-0D93-439b-9E6D-26BE130C9784} - uses NDIS_PM_PROTOCOL_OFFLOAD
DEFINE_GUID(GUID_PM_ADD_PROTOCOL_OFFLOAD,           0x0c06c112, 0x0d93, 0x439b, 0x9e, 0x6d, 0x26, 0xbe, 0x13, 0x0c, 0x97, 0x84);
// {A6435CD9-149F-498e-951B-2D94BEA3E3A3} - uses NDIS_PM_PROTOCOL_OFFLOAD
...
//
// GUIDs for receive filters
//
DEFINE_GUID(GUID_NDIS_RECEIVE_FILTER_HARDWARE_CAPABILITIES,     0x3f2c1419, 0x83bc, 0x11dd, 0x94, 0xb8, 0x00, 0x1d, 0x09, 0x16, 0x2b, 0xc3); // uses NDIS_RECEIVE_FILTER_CAPABILITIES
DEFINE_GUID(GUID_NDIS_RECEIVE_FILTER_GLOBAL_PARAMETERS,         0x3f2c141a, 0x83bc, 0x11dd, 0x94, 0xb8, 0x00, 0x1d, 0x09, 0x16, 0x2b, 0xc3); // uses NDIS_RECEIVE_FILTER_GLOBAL_PARAMETERS
DEFINE_GUID(GUID_NDIS_RECEIVE_FILTER_ENUM_QUEUES,               0x3f2c141b, 0x83bc, 0x11dd, 0x94, 0xb8, 0x00, 0x1d, 0x09, 0x16, 0x2b, 0xc3); // uses NDIS_RECEIVE_QUEUE_INFO_ARRAY
DEFINE_GUID(GUID_NDIS_RECEIVE_FILTER_QUEUE_PARAMETERS,          0x3f2c141c, 0x83bc, 0x11dd, 0x94, 0xb8, 0x00, 0x1d, 0x09, 0x16, 0x2b, 0xc3); // uses NDIS_RECEIVE_QUEUE_PARAMETERS
DEFINE_GUID(GUID_NDIS_RECEIVE_FILTER_ENUM_FILTERS,              0x3f2c141d, 0x83bc, 0x11dd, 0x94, 0xb8, 0x00, 0x1d, 0x09, 0x16, 0x2b, 0xc3); // uses NDIS_RECEIVE_FILTER_INFO_ARRAY
DEFINE_GUID(GUID_NDIS_RECEIVE_FILTER_PARAMETERS,                0x3f2c141e, 0x83bc, 0x11dd, 0x94, 0xb8, 0x00, 0x1d, 0x09, 0x16, 0x2b, 0xc3); // uses NDIS_RECEIVE_FILTER_PARAMETERS
DEFINE_GUID(GUID_RECEIVE_FILTER_CURRENT_CAPABILITIES,           0x4054e80f, 0x2bc1, 0x4ccc, 0xb0, 0x33, 0x4a, 0xbc, 0x0c, 0x4a, 0x1e, 0x8c); // uses RECEIVE_FILTER_CAPABILITIES
DEFINE_GUID(GUID_NIC_SWITCH_HARDWARE_CAPABILITIES,              0x37cab40c, 0xd1e8, 0x4301, 0x8c, 0x1d, 0x58, 0x46, 0x5e, 0x0c, 0x4c, 0x0f); // uses NIC_SWITCH_CAPABILITIES
DEFINE_GUID(GUID_NIC_SWITCH_CURRENT_CAPABILITIES,               0xe76fdaf3, 0x0be7, 0x4d95, 0x87, 0xe9, 0x5a, 0xea, 0xd4, 0xb5, 0x90, 0xe9); // uses NIC_SWITCH_CAPABILITIES

//
// GUIDs for switch policy
//
DEFINE_GUID(GUID_NDIS_SWITCH_MICROSOFT_VENDOR_ID,               0x202547fe, 0x1c9c, 0x40b9, 0xbb, 0xa1, 0x8, 0xad, 0xa1, 0xf9, 0x8b, 0x3c);                   
DEFINE_GUID(GUID_NDIS_SWITCH_PORT_PROPERTY_PROFILE_ID_DEFAULT_EXTERNAL_NIC, 0xb347846, 0xa0c, 0x470a, 0x9b, 0x7a, 0xd, 0x96, 0x58, 0x50, 0x69, 0x8f);
...
DEFINE_GUID(GUID_NDIS_STATUS_EXTERNAL_CONNECTIVITY_CHANGE, 0xfd306974, 0xc420, 0x4433, 0xb0, 0xfe, 0x4c, 0xf6, 0xa6, 0x13, 0xf5, 0x9f);
...
DEFINE_GUID(GUID_NDIS_STATUS_PM_WOL_PATTERN_REJECTED,  0xf72cf68e, 0x18d4, 0x4d63, 0x9a, 0x19, 0xe6, 0x9b, 0x13, 0x91, 0x6b, 0x1a);
DEFINE_GUID(GUID_NDIS_STATUS_PM_OFFLOAD_REJECTED,      0xadd1d481, 0x711e, 0x4d1a, 0x92, 0xca, 0xa6, 0x2d, 0xb9, 0x32, 0x97, 0x12);
DEFINE_GUID(GUID_NDIS_STATUS_PM_WAKE_REASON,           0x0933fd58, 0xca62, 0x438f, 0x83, 0xda, 0xdf, 0xc1, 0xcc, 0xcb, 0x81, 0x45);
