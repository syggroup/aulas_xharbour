...
#define NERR_AlreadyCloudDomainJoined      (NERR_BASE+600) /*This machine is already joined to a cloud domain and cannot be subsequently joined to an Active Directory domain.*/
