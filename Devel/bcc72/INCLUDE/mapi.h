...
#define MAPI_DIALOG_MODELESS    0x00000004 | MAPI_DIALOG  /* Display a modeless window    */
#define MAPI_FORCE_UNICODE      0x00040000  /* Don't down-convert to ANSI if provider does not support Unicode */
