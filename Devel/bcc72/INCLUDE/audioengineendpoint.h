...
#ifndef __IAudioEndpointReleaseBufferControl_FWD_DEFINED__
#define __IAudioEndpointReleaseBufferControl_FWD_DEFINED__
typedef interface IAudioEndpointReleaseBufferControl IAudioEndpointReleaseBufferControl;

#endif 	/* __IAudioEndpointReleaseBufferControl_FWD_DEFINED__ */
...
enum __MIDL___MIDL_itf_audioengineendpoint_0000_0000_0001
    {
        ...
        eBestConnectorAvailable	= ( eKeywordDetectorConnector + 1 ) 
...
#ifndef __IAudioEndpointReleaseBufferControl_INTERFACE_DEFINED__
#define __IAudioEndpointReleaseBufferControl_INTERFACE_DEFINED__

/* interface IAudioEndpointReleaseBufferControl */
/* [local][unique][uuid][object] */ 


EXTERN_C const IID IID_IAudioEndpointReleaseBufferControl;

#if defined(__cplusplus) && !defined(CINTERFACE)
    
    MIDL_INTERFACE("D3B4C8FA-8C51-4740-A943-092D9BF57151")
    IAudioEndpointReleaseBufferControl : public IUnknown
    {
    public:
        virtual BOOL STDMETHODCALLTYPE IsReleasedBufferControlSupported( void) = 0;
        
        virtual HRESULT STDMETHODCALLTYPE GetReleaseBufferEventHandle( 
            /* [annotation][out] */ 
            _Out_  HANDLE *phReleaseBufferEventHandle) = 0;
    ...
    typedef struct IAudioEndpointReleaseBufferControlVtbl
    {
        BEGIN_INTERFACE
        
        HRESULT ( STDMETHODCALLTYPE *QueryInterface )( 
            IAudioEndpointReleaseBufferControl * This,
            /* [in] */ REFIID riid,
            /* [annotation][iid_is][out] */ 
            _COM_Outptr_  void **ppvObject);
        ...
        BOOL ( STDMETHODCALLTYPE *IsReleasedBufferControlSupported )( 
            IAudioEndpointReleaseBufferControl * This);
        
        HRESULT ( STDMETHODCALLTYPE *GetReleaseBufferEventHandle )( 
            IAudioEndpointReleaseBufferControl * This,
            /* [annotation][out] */ 
            _Out_  HANDLE *phReleaseBufferEventHandle);
        
        END_INTERFACE
    } IAudioEndpointReleaseBufferControlVtbl;

    interface IAudioEndpointReleaseBufferControl
    {
        CONST_VTBL struct IAudioEndpointReleaseBufferControlVtbl *lpVtbl;
    };
...
#define IAudioEndpointReleaseBufferControl_QueryInterface(This,riid,ppvObject)	\
    ( (This)->lpVtbl -> QueryInterface(This,riid,ppvObject) ) 

#define IAudioEndpointReleaseBufferControl_AddRef(This)	\
    ( (This)->lpVtbl -> AddRef(This) ) 

#define IAudioEndpointReleaseBufferControl_Release(This)	\
    ( (This)->lpVtbl -> Release(This) ) 


#define IAudioEndpointReleaseBufferControl_IsReleasedBufferControlSupported(This)	\
    ( (This)->lpVtbl -> IsReleasedBufferControlSupported(This) ) 

#define IAudioEndpointReleaseBufferControl_GetReleaseBufferEventHandle(This,phReleaseBufferEventHandle)	\
    ( (This)->lpVtbl -> GetReleaseBufferEventHandle(This,phReleaseBufferEventHandle) ) 
...
#endif 	/* __IAudioEndpointReleaseBufferControl_INTERFACE_DEFINED__ */
...
/* interface __MIDL_itf_audioengineendpoint_0000_0013 */
/* [local] */ 
...
extern RPC_IF_HANDLE __MIDL_itf_audioengineendpoint_0000_0013_v0_0_c_ifspec;
extern RPC_IF_HANDLE __MIDL_itf_audioengineendpoint_0000_0013_v0_0_s_ifspec;
