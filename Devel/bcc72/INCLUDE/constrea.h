...
ostream& _RTLENTRY _EXPFUNC clreol( ostream& );
ostream& _RTLENTRY _EXPFUNC highvideo( ostream& );
ostream& _RTLENTRY _EXPFUNC lowvideo( ostream& );
ostream& _RTLENTRY _EXPFUNC normvideo( ostream& );
ostream& _RTLENTRY _EXPFUNC delline( ostream& );
ostream& _RTLENTRY _EXPFUNC insline( ostream& );

omanip1<int> _RTLENTRY _EXPFUNC setcrsrtype( int );
omanip1<int> _RTLENTRY _EXPFUNC setattr( int );
omanip1<int> _RTLENTRY _EXPFUNC setbk( int );
omanip1<int> _RTLENTRY _EXPFUNC setclr( int );
omanip2<int,int> _RTLENTRY _EXPFUNC setxy( int, int );
