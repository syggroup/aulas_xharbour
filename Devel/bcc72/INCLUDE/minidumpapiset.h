...
typedef MINIDUMP_PROCESS_VM_COUNTERS_1 MINIDUMP_PROCESS_VM_COUNTERS_N;
...
typedef enum _STATUS_SPEW_FLAGS
{
    StatusSpewStatus      = 0x0001,
    StatusSpewWarning     = 0x0002,
    StatusSpewError       = 0x0004,
    StatusSpewDataMissing = 0x0008,
} STATUS_SPEW_FLAGS;

typedef struct _MINIDUMP_STATUS_SPEW_CALLBACK
{
    ULONG SpewFlags;
    PCSTR Status;
} MINIDUMP_STATUS_SPEW_CALLBACK, *PMINIDUMP_STATUS_SPEW_CALLBACK;
...
typedef struct _MINIDUMP_CALLBACK_INPUT {
    ...
    union {
        ...
        MINIDUMP_STATUS_SPEW_CALLBACK StatusSpew;
