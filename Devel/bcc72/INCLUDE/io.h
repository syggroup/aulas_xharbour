...
int  _RTLENTRY _EXPFUNC _rtl_creat  (const char _FAR *__path, int __attr);
int  _RTLENTRY _EXPFUNC _creat  (const char _FAR *__path, int __attr);
...
int  _RTLENTRY _EXPFUNC _wrtl_creat(const wchar_t *__path, int __attr);
...
int  _RTLENTRY  _EXPFUNC _open_osfhandle(intptr_t __osfhandle, int __oflag);
...
__int64 _RTLENTRY _EXPFUNC _lseeki64(int __handle, __int64 __offset, int __fromwhere);
...
int  _RTLENTRY _EXPFUNC _open (const char _FAR *__path, int __oflags,... /*unsigned mode*/);
...
__int64 _RTLENTRY _EXPFUNC _telli64(int __handle);
