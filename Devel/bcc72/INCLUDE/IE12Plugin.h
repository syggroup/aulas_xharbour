...
#ifndef __IImmersiveUIHandlerSite_FWD_DEFINED__
#define __IImmersiveUIHandlerSite_FWD_DEFINED__
typedef interface IImmersiveUIHandlerSite IImmersiveUIHandlerSite;

#endif 	/* __IImmersiveUIHandlerSite_FWD_DEFINED__ */
...
#ifndef __IImmersiveUIHandlerSite_INTERFACE_DEFINED__
#define __IImmersiveUIHandlerSite_INTERFACE_DEFINED__

/* interface IImmersiveUIHandlerSite */
/* [uuid][unique][object] */ 


EXTERN_C const IID IID_IImmersiveUIHandlerSite;

#if defined(__cplusplus) && !defined(CINTERFACE)
    
    MIDL_INTERFACE("7E3707B2-D087-4542-AC1F-A0D2FCD080FD")
    IImmersiveUIHandlerSite : public IUnknown
    {
    public:
    ...
    typedef struct IImmersiveUIHandlerSiteVtbl
    {
        BEGIN_INTERFACE
        
        HRESULT ( STDMETHODCALLTYPE *QueryInterface )( 
            __RPC__in IImmersiveUIHandlerSite * This,
            /* [in] */ __RPC__in REFIID riid,
            /* [annotation][iid_is][out] */ 
            _COM_Outptr_  void **ppvObject);
        ...
        END_INTERFACE
    } IImmersiveUIHandlerSiteVtbl;

    interface IImmersiveUIHandlerSite
    {
        CONST_VTBL struct IImmersiveUIHandlerSiteVtbl *lpVtbl;
    };
...
#define IImmersiveUIHandlerSite_QueryInterface(This,riid,ppvObject)	\
    ( (This)->lpVtbl -> QueryInterface(This,riid,ppvObject) ) 

#define IImmersiveUIHandlerSite_AddRef(This)	\
    ( (This)->lpVtbl -> AddRef(This) ) 

#define IImmersiveUIHandlerSite_Release(This)	\
    ( (This)->lpVtbl -> Release(This) ) 


#define IImmersiveUIHandlerSite_AddSuspensionExemption(This,pullCookie)	\
    ( (This)->lpVtbl -> AddSuspensionExemption(This,pullCookie) ) 

#define IImmersiveUIHandlerSite_RemoveSuspensionExemption(This,ullCookie)	\
...
#endif 	/* __IImmersiveUIHandlerSite_INTERFACE_DEFINED__ */
...
/* interface __MIDL_itf_ie12plugin_0000_0014 */
/* [local] */ 

//;end_internal


extern RPC_IF_HANDLE __MIDL_itf_ie12plugin_0000_0014_v0_0_c_ifspec;
extern RPC_IF_HANDLE __MIDL_itf_ie12plugin_0000_0014_v0_0_s_ifspec;
