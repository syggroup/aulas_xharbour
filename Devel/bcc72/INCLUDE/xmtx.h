...
_CRTIMP2 void _Mtxinit(_Rmtx *);
_CRTIMP2 void _Mtxdst(_Rmtx *);
_CRTIMP2 void _Mtxlock(_Rmtx *);
_CRTIMP2 void _Mtxunlock(_Rmtx *);
...
_CRTIMP2 void _Once(_Once_t *, void (*)(void));
  #define _ONCE_T_INIT	0
