...
enum __MIDL___MIDL_itf_mfidl_0000_0026_0001
    {
        MF_ACTIVATE_CUSTOM_MIXER_ALLOWFAIL	= 0x1
    } ;

enum __MIDL___MIDL_itf_mfidl_0000_0026_0002
    {
...
#if (WINVER >= _WIN32_WINNT_WIN8) 
typedef /* [public][public] */ struct __MIDL___MIDL_itf_mfidl_0000_0056_0001
    {
    QWORD qwStartOffset;
    QWORD qwEndOffset;
...
STDAPI MFCheckContentProtectionDevice( 
   _In_ REFGUID ProtectionSystemId); 
