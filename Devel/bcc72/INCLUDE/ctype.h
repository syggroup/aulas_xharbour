...
int _RTLENTRY _EXPFUNC isblank (int __c);
...
int _RTLENTRY _EXPFUNC iswblank (_WINT_T __c);
...
#define isblank(c)   (__STD _chartype[ (c)+1 ] & (_IS_BLK))
...
#define isprint(c)   (__STD _chartype[ (c)+1 ] & (_IS_GRAPH) || c == ' ')
...
#define iswblank(c)   (__STD _chartype[ (c)+1 ] & (_IS_BLK))
...
int     _RTLENTRY _EXPFUNC _ltolower_lcid(int __ch, unsigned long __handle);
int     _RTLENTRY _EXPFUNC _ltoupper(int __ch);
int     _RTLENTRY _EXPFUNC _ltoupper_lcid(int __ch, unsigned long __handle);
...
__inline
#endif
int     _RTLENTRY tolower(int __ch)      { return _ltolower(__ch);  }

#ifndef __STDC__
__inline
#endif
int     _RTLENTRY toupper(int __ch)      { return _ltoupper(__ch);  }

#ifndef __STDC__
__inline
#endif
_WINT_T _RTLENTRY towlower(_WINT_T __ch) { return _ltowlower(__ch); }

#ifndef __STDC__
__inline
#endif
_WINT_T _RTLENTRY towupper(_WINT_T __ch) { return _ltowupper(__ch); }
