...
extern "C" {
#endif
#if defined(__USELOCALES__) && defined(_BUILDRTLDLL) 
char *         _RTLENTRY setlocale( int __category, const char *__locale );
wchar_t *      _RTLENTRY _wsetlocale( int __category, const wchar_t *__locale );
#else
...
#if defined(__cplusplus) && !defined(_BUILDRTLDLL)
inline char *    _RTLENTRY setlocale( int __category, const char *__locale )
    { return _lsetlocale( __category, __locale); }
inline wchar_t * _RTLENTRY _wsetlocale( int __category, const wchar_t *__locale )
