...
#if (NTDDI_VERSION >= NTDDI_WINBLUE)  // TODO: replace with #if (NTDDI_VERSION >= NTDDI_WINTHRESHOLD) when the default becomes NTDDI_WINTHRESHOLD
...
#endif
    KSPROPERTY_CAMERACONTROL_EXTENDED_END2                   // All new controls must be before this! // TODO: replace END2 with END when the default becomes NTDDI_WINTHRESHOLD
...
#define KSCAMERA_EXTENDEDPROP_FACEDETECTION_ON                  0x0000000000000001  // TODO: Remove ON flag when CCP, tests are updated
