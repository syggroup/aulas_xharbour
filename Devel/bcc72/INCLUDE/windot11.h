...
// Data Type for NDIS_STATUS_DOT11_WFD_GROUP_OPERATING_CHANNEL_UPDATE
#define DOT11_WFD_GROUP_OPERATING_CHANNEL_UPDATE_PARAMETERS_REVISION_1    1
#define DOT11_SIZEOF_WFD_GROUP_OPERATING_CHANNEL_UPDATE_PARAMETERS_REVISION_1   \
            sizeof(DOT11_WFD_GROUP_OPERATING_CHANNEL_UPDATE_PARAMETERS)

    typedef
    enum _DOT11_P2P_CHANNEL_INDICATE_REASON
    {
        DOT11_P2P_CHANNEL_INDICATE_REASON_UNKNOWN = 0,
        DOT11_P2P_CHANNEL_INDICATE_REASON_NEW_CONNECTION = 1,
        DOT11_P2P_CHANNEL_INDICATE_REASON_ECSA_REQUESTED = 2,
        DOT11_P2P_CHANNEL_INDICATE_REASON_ECSA_GO_INITIATED = 3,
        DOT11_P2P_CHANNEL_INDICATE_REASON_MAX = 0xFFFFFFFF
    } DOT11_P2P_CHANNEL_INDICATE_REASON;

    typedef 
    struct _DOT11_WFD_GROUP_OPERATING_CHANNEL_UPDATE_PARAMETERS 
    {
        NDIS_OBJECT_HEADER Header;
        DOT11_WFD_CHANNEL WFDChannel;
        DOT11_P2P_CHANNEL_INDICATE_REASON Reason;
    } DOT11_WFD_GROUP_OPERATING_CHANNEL_UPDATE_PARAMETERS, * PDOT11_WFD_GROUP_OPERATING_CHANNEL_UPDATE_PARAMETERS;
