...
#define _vsntprintf_s   vsnprintf_s
...
#if 0 /* FIXME: _TINT should probably be unsigned but is documented as
	 int by Microsoft in "Data Type Mappings" */
...
inline char * _RTLENTRY strdec(const char * __s1, const char * __s2) { return (char *)((__s1 >= __s2) ? 0 : (__s2-1)); }

inline char * _RTLENTRY _strinc(const char * __s) { return (char *)(__s+1); }
inline char * _RTLENTRY _strdec(const char * __s1, const char * __s2) { return (char *)((__s1 >= __s2) ? 0 : (__s2-1)); }
...
inline _SIZE_T _RTLENTRY _strncnt( const char * __s, _SIZE_T __n) { _SIZE_T __len; __len = std::strlen(__s); return (__len>__n) ? __n : __len; }
inline char * _RTLENTRY _strspnp( const char * __s1, const char * __s2) { return (*(__s1 += std::strspn(__s1,__s2))!='\0') ? (char*)__s1 : NULL; }
...
#define _tasctime_s     wasctime_s
#define _tutime         _wutime
#define _tctime         _wctime
#define _tctime_s       wctime_s
...
#define _vsntprintf_s   vsnwprintf_s
