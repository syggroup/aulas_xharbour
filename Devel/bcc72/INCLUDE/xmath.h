...
_C_LIB_DECL
_CRTIMP2 int _Stopfx(const char **, char **);
_CRTIMP2 int _Stoflt(const char *, const char *, char **,
	long[], int);
_CRTIMP2 int _Stoxflt(const char *, const char *, char **,
	long[], int);
_CRTIMP2 int _WStopfx(const wchar_t **, wchar_t **);
_CRTIMP2 int _WStoflt(const wchar_t *, const wchar_t *, wchar_t **,
	long[], int);
_CRTIMP2 int _WStoxflt(const wchar_t *, const wchar_t *, wchar_t **,
	long[], int);
...
_CRTIMP2 double _Hypot(double, double, int *);
_CRTIMP2 double _Poly(double, const double *, int);
_CRTIMP2 extern /* const */ _Dconst _Eps, _Rteps;
_CRTIMP2 extern /* const */ double _Xbig, _Zero;
...
_CRTIMP2 float _FHypot(float, float, int *);
...
_CRTIMP2 long double _LHypot(long double, long double, int *);
_CRTIMP2 long double _LPoly(long double, const long double *, int);
_CRTIMP2 extern /* const */ _Dconst _LEps, _LRteps;
_CRTIMP2 extern /* const */ long double _LXbig, _LZero;
