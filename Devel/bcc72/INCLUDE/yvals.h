...
#if defined(_WIN64) /* defined(__clang__) && !defined(__clang_analyzer__) */
#error Please use headers from dinkumware64 directory
#endif
 ...
 */
  ...
  #define __STDC_ISO_10646__	200009L	/* match glibc */
   ...
   || defined(__i386__) || defined(_M_IX86) || defined(__CODEGEARC__)	/* Pentium */
  ...
  #elif defined(__CODEGEARC__) && !__EDG__

   //#pragma defineonoption _NO_EX -x-

  // FIXME: remove when exceptions are supported for CLANG32
...
typedef unsigned int _Sizet;
  ...
  #define _LINUX_C_LIB	1	/* Linux-specific conventions */
   ...
   || defined(_M_ALPHA) || defined(_M_IA64) || defined(_WIN32_WCE) || defined(_WIN64)
...
#define _USE_INTERLOCK_	1 /* 0 for original locks, 1 for using InterlockIncrement/Decrement */
...
#define _HAS_NEW_RVALUE_REFERENCES 1
...
namespace std {
  ...
  #elif defined(__CODEGEARC__) && defined(__linux__)
   #define _GLOBAL_USING	/* c* headers import C names to std */
  #endif /* defined(_STD_USING) */
...
typedef char *va_list;
 ...
 #if _WIN32_C_LIB && !defined(__CODEGEARC__)
...
#if _MULTI_THREAD || defined(__clang__)
_EXTERN_C
_CRTIMP2 void _Locksyslock(int);
_CRTIMP2 void _Unlocksyslock(int);

long _CRTIMP2 _InterlockedIncrement(long volatile *);
long _CRTIMP2 _InterlockedDecrement(long volatile *);
...
V5.01:1422 +rval +char16_t/char32_t */
