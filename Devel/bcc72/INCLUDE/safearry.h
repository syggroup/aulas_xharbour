...
#if !defined(_Windows)
typedef TVarArray SAFEARRAY;
typedef TVarArrayBound SAFEARRAYBOUND;
typedef TVarType VARENUM;
#endif
...
#else  
  m_Bounds[0].LowBound   = 0;
  m_Bounds[0].ElementCount = dim1Len;
#endif  
}
...
TArrayDimT<DIM>::TArrayDimT(int dim1Len, int dim2Len)
{
  ...
  m_Bounds[0].LowBound   = 0;
  m_Bounds[0].ElementCount = dim1Len;
  m_Bounds[1].LowBound   = 0;
  m_Bounds[1].ElementCount = dim2Len;
#endif  
...
TArrayDimT<DIM>::TArrayDimT(int dim1Len, int dim2Len, int dim3Len)
{
  ...
  m_Bounds[1].LowBound   = 0;
  m_Bounds[1].ElementCount = dim2Len;
  m_Bounds[2].LowBound   = 0;
  m_Bounds[2].ElementCount = dim3Len;
#endif  
}
...
/* template <> */ inline
IDispatch* TweakTeacake(IDispatch* pdsp)
{
  return pdsp;
}
...
#else
    int lb, ub;
    Varutils::SafeArrayGetUBound(m_psa, idx+1/*1-based*/, ub);
    Varutils::SafeArrayGetLBound(m_psa, idx+1/*1-based*/, lb);
#endif    
    len = (ub-lb) + 1;
  }
  return len;
...
#pragma option push -w-8104
    ...
    static TDllStdProc2<SAFEARRAY*, VARTYPE*> SafeArrayGetVartypeProc(oleAut32, "SafeArrayGetVartype");
#pragma option pop
...
typedef TSafeArrayT<char, varShortInt, 1>       TSafeArrayChar1;
typedef TSafeArrayT<char, varShortInt, 2>       TSafeArrayChar2;
typedef TSafeArrayT<char, varShortInt, 3>       TSafeArrayChar3;

typedef TSafeArrayT<unsigned char, varByte, 1>   TSafeArrayUChar1;
typedef TSafeArrayT<unsigned char, varByte, 2>   TSafeArrayUChar2;
typedef TSafeArrayT<unsigned char, varByte, 3>   TSafeArrayUChar3;

typedef TSafeArrayT<short, varSmallint, 1>       TSafeArrayShort1;
typedef TSafeArrayT<short, varSmallint, 2>       TSafeArrayShort2;
typedef TSafeArrayT<short, varSmallint, 3>       TSafeArrayShort3;

typedef TSafeArrayT<unsigned short, varSmallint, 1>   TSafeArrayUShort1;
typedef TSafeArrayT<unsigned short, varSmallint, 2>   TSafeArrayUShort2;
typedef TSafeArrayT<unsigned short, varSmallint, 3>   TSafeArrayUShort3;

typedef TSafeArrayT<int, varInteger, 1>          TSafeArrayInt1;
typedef TSafeArrayT<int, varInteger, 2>          TSafeArrayInt2;
typedef TSafeArrayT<int, varInteger, 3>          TSafeArrayInt3;

typedef TSafeArrayT<long, varInteger, 1>         TSafeArrayLong1;
typedef TSafeArrayT<long, varInteger, 2>         TSafeArrayLong2;
typedef TSafeArrayT<long, varInteger, 3>         TSafeArrayLong3;

typedef TSafeArrayT<unsigned int, varInteger, 1> TSafeArrayUInt1;
typedef TSafeArrayT<unsigned int, varInteger, 2> TSafeArrayUInt2;
typedef TSafeArrayT<unsigned int, varInteger, 3> TSafeArrayUInt3;

typedef TSafeArrayT<double, varDouble, 1>        TSafeArrayDouble1;
typedef TSafeArrayT<double, varDouble, 2>        TSafeArrayDouble2;
typedef TSafeArrayT<double, varDouble, 3>        TSafeArrayDouble3;

typedef TSafeArrayT<LPUNKNOWN, varUnknown, 1>   TSafeArrayUnknown1;
typedef TSafeArrayT<LPUNKNOWN, varUnknown, 2>   TSafeArrayUnknown2;
typedef TSafeArrayT<LPUNKNOWN, varUnknown, 3>   TSafeArrayUnknown3;

typedef TSafeArrayT<IDispatch*, varDispatch, 1> TSafeArrayDispatch1;
typedef TSafeArrayT<IDispatch*, varDispatch, 2> TSafeArrayDispatch2;
typedef TSafeArrayT<IDispatch*, varDispatch, 3> TSafeArrayDispatch3;
#endif
