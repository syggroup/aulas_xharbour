...
#define CERT_FIRST_RESERVED_PROP_ID            119
...
// Set this flag to check if a cache entry already exists for this URL.
...
// pvVerify should be a PCRYPT_BLOB_ARRAY containing the content to be written.
#define CRYPT_CREATE_NEW_CACHE_ENTRY            0x10000000
