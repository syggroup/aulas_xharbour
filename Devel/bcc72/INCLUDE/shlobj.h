...
typedef struct tagNT_CONSOLE_PROPS {
#else
typedef struct {
#endif
#ifdef __cplusplus
...
#if defined(__CODEGEARC__)
typedef struct tagNT_FE_CONSOLE_PROPS {
#else
typedef struct {
#endif
#ifdef __cplusplus
...
#if defined(__CODEGEARC__)
typedef struct tagEXP_DARWIN_LINK {
#else
typedef struct {
#endif
#ifdef __cplusplus
...
#if defined(__CODEGEARC__)
typedef struct tagEXP_SPECIAL_FOLDER
#else
typedef struct
#endif
{
...
#if (NTDDI_VERSION >= NTDDI_VISTA)
#if defined(__CODEGEARC__)
typedef struct tagEXP_PROPERTYSTORAGE
#else
typedef struct
#endif
{
...
#if defined(__CODEGEARC__)
typedef struct tagSHFOLDERCUSTOMSETTINGS
#else
typedef struct
#endif
{
...
#if defined(__CODEGEARC__)
typedef struct tagSHCOLUMNINFO {
#else
typedef struct {
#endif
...
#if defined(__CODEGEARC__)
typedef struct tagSHCOLUMNINIT {
#else
typedef struct {
#endif
...
#if defined(__CODEGEARC__)
typedef struct tagSHCOLUMNDATA {
#else
typedef struct {
#endif
...
#if (NTDDI_VERSION >= NTDDI_VISTA)
#if defined(__CODEGEARC__)
typedef struct tagFILE_ATTRIBUTES_ARRAY
#else
typedef struct
#endif
{
...
#if defined(__CODEGEARC__)
typedef struct tagDROPDESCRIPTION
#else
typedef struct
#endif
{
...
#define NUM_POINTS      3
#if defined(__CODEGEARC__)
typedef struct tagAUTO_SCROLL_DATA {
#else
typedef struct {        // asd
#endif
    int iNextSample;
...
#if defined(__CODEGEARC__)
typedef struct tagCABINETSTATE {
#else
typedef struct {
#endif
    WORD cLength;
...
#if defined(__CODEGEARC__)
typedef struct tagDEFCONTEXTMENU {
#else
typedef struct {
#endif
    HWND hwnd;
...
//
#if defined(__CODEGEARC__)
typedef struct tagSHELLFLAGSTATE {
#else
typedef struct {
#endif
    BOOL fShowAllObjects : 1;
...
#if defined(__CODEGEARC__)
           (UINT) pidl->mkid.cb <= cbAlloc - cbPidl)           // doesn't go past end of buffer
#else
