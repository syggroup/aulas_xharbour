...
#else
UINT    WINAPI ImeToAsciiEx(IN UINT uVirtKey, IN UINT uScaCode, _In_reads_bytes_(256) CONST LPBYTE lpbKeyState, _Out_ LPDWORD lpdwTransBuf, IN UINT fuState, IN HIMC hIMC);
#endif /* WINVER >= 0x040A */
