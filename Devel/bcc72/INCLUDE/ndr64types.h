...
typedef struct _NDR64_PROC_FLAGS
{
    ...
    NDR64_UINT32    HasArmParamLayout       : 1;        // 0x04000000
    NDR64_UINT32    Reserved                : 5;        // 0x08000000
} NDR64_PROC_FLAGS;
...
typedef struct _NDR64_RPC_FLAGS
{
    ...
    NDR64_UINT16    WinrtRemoteAsync    : 1;
} NDR64_RPC_FLAGS;
...
{
    NDR64_FORMAT_CHAR FormatCode;
    NDR64_UINT8       HandleType;
    NDR64_UINT32      DesiredAccess;
