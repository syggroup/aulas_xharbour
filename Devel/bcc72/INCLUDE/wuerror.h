...
//
// MessageId: WU_E_DM_NEEDBATCHDOWNLOADREQUEST
//
// MessageText:
//
// An operation could not be completed because a batched download request is required from the download handler.
//
#define WU_E_DM_NEEDBATCHDOWNLOADREQUEST _HRESULT_TYPEDEF_(0x80246015L)
...
//
// MessageId: WU_E_DM_UNAUTHORIZED_NO_LICENSE
//
// MessageText:
//
// The download failed because the user has no license to download the content.
//
#define WU_E_DM_UNAUTHORIZED_NO_LICENSE  _HRESULT_TYPEDEF_(0x80246019L)
