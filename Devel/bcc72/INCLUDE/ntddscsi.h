...
#define DUMP_POINTERS_EX_V2_SIZE    FIELD_OFFSET(DUMP_POINTERS_EX, dwPortFlags)
#define DUMP_POINTERS_EX_V3_SIZE    sizeof(DUMP_POINTERS_EX)

#elif (NTDDI_VERSION >= NTDDI_WINBLUE)

#define DUMP_POINTERS_EX_V2_SIZE    FIELD_OFFSET(DUMP_POINTERS_EX, dwPortFlags)
#define DUMP_POINTERS_EX_V3_SIZE    FIELD_OFFSET(DUMP_POINTERS_EX, DumpDevicePowerOn)
