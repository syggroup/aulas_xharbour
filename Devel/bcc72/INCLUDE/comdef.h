...
#ifdef __CODEGEARC__
                new (const_cast<_com_error*>(this)) _com_error(that);
#else  /* __CODEGEARC__ */
...
#pragma prefast(suppress: __WARNING_BANNED_API_USAGE __WARNING_BANNED_API_USAGE, "STRSAFE not included")
...
#endif
#else /* __CODEGEARC__ */
	// redefinition of ptr templates to avoid problems with
	// static linkage of uuidof
#if defined(_COM_SMARTPTR)
 #if !defined(_COM_SMARTPTR_TYPEDEF)
  #if defined(_COM_SMARTPTR_LEVEL2)
   #define _COM_SMARTPTR_TYPEDEF( Interface, IIDARG ) \
    typedef _COM_SMARTPTR< _COM_SMARTPTR_LEVEL2< Interface, ((const IID*)0) > > \
	    Interface ## Ptr
  #else
   #define _COM_SMARTPTR_TYPEDEF(Interface, IIDARG) \
    typedef _COM_SMARTPTR<Interface> \
	    Interface ## Ptr
  #endif
 #endif
#endif
