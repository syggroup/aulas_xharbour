...
interface DWRITE_DECLARE_INTERFACE("9a1b41c3-d3bb-466a-87fc-fe67556a3b65") IDWriteFactory3 : public IDWriteFactory2
{
    ...
    /// </summary>
    /// <param name="includeDownloadableFonts">Include all fonts or only locally installed ones.</param>
...
interface DWRITE_DECLARE_INTERFACE("53585141-D9F8-4095-8321-D73CF6BD116B") IDWriteFontSet : public IUnknown
{
    ...
    /// always be equal to or less than the original set. If you only
    /// want to filter out remote fonts, you may pass null properties and zero
    /// propertyCount.
    /// </remarks>
