...
METHOD NewRg( oWndParent, nId, nStyle, vari, bSetGet, nLeft, nTop, nWidth, nHeight, ;
              cCaption, oFont, bInit, bSize,tcolor, bColor,bClick,;
              bGFocus,lTransp, lNAOTraduz ) CLASS HRadioGroup
   ...
   ::oHGroup := HGroup():New( oWndParent, nId, nStyle, nLeft, nTop, nWidth, nHeight, cCaption, ;
                              oFont, bInit, bSize, , tcolor, bColor, lTransp, Self, lNAOTraduz )
...
CLASS VAR winclass   INIT "BUTTON"
   ...
   METHOD New( oWndParent, nId, nStyle, nLeft, nTop, nWidth, nHeight, cCaption, oFont, ;
               bInit, bSize, bPaint, bClick, ctooltip, tcolor, bcolor, bGFocus, lTransp, lNAOTraduz )
   METHOD Activate()
   METHOD Init()
...
METHOD New( oWndParent, nId, nStyle, nLeft, nTop, nWidth, nHeight, cCaption, oFont, ;
            bInit, bSize, bPaint, bClick, ctooltip, tcolor, bcolor, bGFocus, lTransp, lNAOTraduz ) CLASS HRadioButton
   ...
   // RADIOBUTTON - Ana Brock - Projeto TRADUZIR - 19/01/2018
   IF ::lNAOTraduz
      ::title   := cCaption
      ctooltip  := ctooltip
   else
      ::title   := HWG_TRANSLATOR( cCaption, 'RADIOBUTTON' )
      // RADIOBUTTON / TOOLTIP - Ana Brock - Projeto TRADUZIR - 19/01/2018
      // tem que ser aqui antes de (Super:New)
