...
STATIC lNOthemeall   :=  .F.  // desabilita o uso de themas
...
CLASS HControl INHERIT HCustomWindow
 ...
 //  METHOD SetColor( tcolor, bColor, lRepaint )
   ...
   METHOD SetToolTip( ctooltip, lNAOTraduz )
...
METHOD SetToolTip ( cToolTip, lNAOTraduz ) CLASS HControl
/*
   lNAOTraduz --> Vem do SAGI como Parâmetro do Método
*/
...
CLASS VAR winclass   INIT "STATIC"
   ...
   DATA lNAOTraduz      INIT .F.        // Não Traduzir

   METHOD New( oWndParent, nId, nStyle, nLeft, nTop, nWidth, nHeight, ;
               cCaption, oFont, bInit, bSize, bPaint, cTooltip, tcolor, ;
               bColor, lTransp, bClick, bDblClick, bOther, lNAOTraduz )
   METHOD Redefine( oWndParent, nId, cCaption, oFont, bInit, ;
...
METHOD New( oWndParent, nId, nStyle, nLeft, nTop, nWidth, nHeight, ;
            cCaption, oFont, bInit, bSize, bPaint, cTooltip, tcolor, ;
            bColor, lTransp, bClick, bDblClick, bOther, lNAOTraduz ) CLASS HStatic
   ...
   // SAY - Ana Brock - Projeto TRADUZIR - 19/01/2018
   If ::lNAOTraduz
      ::title   := cCaption
      ctooltip  := ctooltip
   Else
...
CLASS VAR winclass   INIT "BUTTON"
   ...
   METHOD New( oWndParent, nId, nStyle, nLeft, nTop, nWidth, nHeight, ;
               ...
               tcolor, bColor, bGFocus, lNAOTraduz )
   METHOD Activate()
...
METHOD New( oWndParent, nId, nStyle, nLeft, nTop, nWidth, nHeight, ;
            cCaption, oFont, bInit, bSize, bPaint, bClick, cTooltip, ;
            tcolor, bColor, bGFocus, lNAOTraduz ) CLASS HButton
...
CLASS HButtonEX INHERIT HButton
   ...
   METHOD New( oWndParent, nId, nStyle, nLeft, nTop, nWidth, nHeight, ;
               cCaption, oFont, bInit, bSize, bPaint, bClick, cTooltip, ;
               tcolor, bColor, hBitmap, iStyle, hicon, Transp, bGFocus,;
               nPictureMargin, lnoThemes, bOther, lNAOTraduz )
   DATA iStyle
...
METHOD New( oWndParent, nId, nStyle, nLeft, nTop, nWidth, nHeight, ;
            cCaption, oFont, bInit, bSize, bPaint, bClick, cTooltip, ;
            tcolor, bColor, hBitmap, iStyle, hicon, Transp, bGFocus, ;
            nPictureMargin, lnoThemes, bOther, lNAOTraduz ) CLASS HButtonEx
   ...
   // BUTTON - Ana Brock - Projeto TRADUZIR - 19/01/2018
   If ::lNAOTraduz
      cCaption    := cCaption
      ctooltip    := ctooltip
   Else
...
CLASS VAR winclass   INIT "BUTTON"
   ...
   METHOD New( oWndParent, nId, nStyle, nLeft, nTop, nWidth, nHeight, ;
               cCaption, oFont, bInit, bSize, bPaint, tcolor, bColor, lTransp, oRGroup, lNAOTraduz )
   METHOD Activate()
   METHOD Init()
   METHOD Paint( lpDis )
...
METHOD New( oWndParent, nId, nStyle, nLeft, nTop, nWidth, nHeight, cCaption, ;
            oFont, bInit, bSize, bPaint, tcolor, bColor, lTransp, oRGroup, lNAOTraduz ) CLASS HGroup

   nStyle := Hwg_BitOr( IIf( nStyle == NIL, 0, nStyle ), BS_GROUPBOX )

   ::lNAOTraduz     := IIf( lNAOTraduz  == Nil, .F., lNAOTraduz  )

   // GROUPBOX - Ana Brock - Projeto TRADUZIR - 19/01/2018
   If ::lNAOTraduz
      ::title   := cCaption
   Else
