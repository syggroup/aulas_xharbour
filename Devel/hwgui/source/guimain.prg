...
FUNCTION WriteStatus( oWnd, nPart, cText, lRedraw ) //, lNAOTraduz )
   LOCAL aControls, i
...
/*
      If lNAOTraduz
         cText  := cText
      Else
         cText  := HWG_TRANSLATOR( cText, 'WRITESTATUS' )
      Endif
*/
...
FUNCTION MsgGet( cTitle, cText, nStyle, x, y, nDlgStyle, cResIni )
   ...
   */
   ...
   @ 20, 35 GET cRes  SIZE 260, 26 STYLE WS_TABSTOP + ES_AUTOHSCROLL + nStyle TOOLTIP 'Informe'
