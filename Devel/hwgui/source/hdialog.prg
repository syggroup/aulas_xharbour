...
CLASS VAR aModalDialogs  SHARED INIT { }
   ...
   METHOD New( lType, nStyle, x, y, width, height, cTitle, oFont, bInit, bExit, bSize, ;
               ...
               xResourceID, lExitOnEsc, bcolor, bRefresh, lNoClosable, lNAOTraduz )
   METHOD Activate( lNoModal, bOnActivate, nShow, lMaximized )
...
METHOD NEW( lType, nStyle, x, y, width, height, cTitle, oFont, bInit, bExit, bSize, ;
            bPaint, bGfocus, bLfocus, bOther, lClipper, oBmp, oIcon, lExitOnEnter, nHelpId,;
            xResourceID, lExitOnEsc, bcolor, bRefresh, lNoClosable, lNAOTraduz ) CLASS HDialog
   ...
   // INIT DIALOG - Ana Brock - Projeto TRADUZIR - 19/01/2018
   If ::lNAOTraduz
      ::title   := cTitle
   Else
...
METHOD Activate( lNoModal, bOnActivate, nShow, lMaximized ) CLASS HDialog
   LOCAL oWnd, hParent
/*
   IF ::oParent == Nil
      ::oParent := GetModalDlg()
