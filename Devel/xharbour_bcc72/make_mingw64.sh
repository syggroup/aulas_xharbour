#!/bin/bash
#
# $Id: make_mingw.sh 10039 2014-11-04 11:15:45Z lculik $
#
...
if [ -z "$HB_COMPILER" ]; then export HB_COMPILER=mingw64; fi
...
if [ -z "$HB_BIN_INSTALL" ]; then export HB_BIN_INSTALL=C:/aulas_xharbour/Devel/xharbour_bcc72/bin/; fi    
if [ -z "$HB_LIB_INSTALL" ]; then export HB_LIB_INSTALL=C:/aulas_xharbour/Devel/xharbour_bcc72/lib/; fi    
if [ -z "$HB_INC_INSTALL" ]; then export HB_INC_INSTALL=C:/aulas_xharbour/Devel/xharbour_bcc72/include/; fi
