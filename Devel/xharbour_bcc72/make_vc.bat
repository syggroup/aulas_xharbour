...
rem ============================================================================
rem
rem $Id: make_vc.bat 10158 2016-08-15 21:05:14Z ronpinkas $
rem
...
:SET_VC2015X86
   ...
   IF "%VS140COMNTOOLS%"=="" SET VS120COMNTOOLS=%ProgramFiles(x86)%\Microsoft Visual Studio 14.0\Common7\Tools\
   IF NOT "%VS140COMNTOOLS%"=="" SET VSCOMMONTOOLS=%VS120COMNTOOLS%
...
echo "%RC_DIR%"
SET _PATH=%PATH%
IF EXIST "%CC_DIR%"\vcvarsall.bat CALL "%CC_DIR%"\vcvarsall.bat X86
