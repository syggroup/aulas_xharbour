/*
 * $Id: core.c 10165 2016-10-22 23:23:36Z lculik $
 */
...
{
   return hb_parptrGC( PHB_EXPAT_release, iParam );
}

static PHB_EXPAT PHB_EXPAT_par( int iParam )
{
   void ** ph = ( void ** ) hb_parptrGC( PHB_EXPAT_release, iParam );
...
{
   void ** ph = ( void ** ) hb_gcAlloc( sizeof( PHB_EXPAT ), PHB_EXPAT_release );
...
HB_FUNC( XML_PARSERFREE )
{
   if( PHB_EXPAT_is( 1 ) )
   {
      void ** ph = ( void ** ) hb_parptrGC( PHB_EXPAT_release, 1 );
