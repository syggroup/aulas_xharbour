/*
 * $Id: zipfileheader.h 9685 2012-09-16 05:42:35Z andijahja $
 */
...
{
   return ( WORD ) m_pszFileName.GetSize();
}
...
{
   return ( WORD ) m_pszComment.GetSize();
}
...
{
   return ( WORD ) m_pExtraField.GetSize();
}
