...
FUNCTION MAIN(cRDD, cDsn)
   ...
   cComm  := "SELECT A.CODE_ID AS CODE_ID_A, B.CODE_ID AS CODE_ID_B,";
             "B.DESCR FROM TEST_TABLE1 A, TEST_TABLE2 B WHERE A.CODE_ID LEFT OUTER JOIN B.CODE_ID AND A.DAYS < ?"
