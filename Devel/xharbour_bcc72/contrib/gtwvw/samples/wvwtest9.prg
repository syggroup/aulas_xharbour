/*
 * $Id: wvwtest9.prg 10077 2014-12-18 00:24:11Z lculik $
 */
//-------------------------------------------------------------------//
//
...
/*
   Compile/Link info:
   This program requires WVWMOUSE.PRG and WINAPI.C.
   You may use WVWTEST9.BAT to compile/link this program.
...
FUNCTION DEMO_Browse()
   ...
   index on LAST to TEST1  //20040707
...
function lBoxMessage(cMsg, cTitle)
   ...
   MessageBox(WVW_GETWINDOWHANDLE(), cMsg, cTitle, MB_OK + MB_ICONINFORMATION + MB_SYSTEMMODAL)
return .t.

function lYesNo(cMsg, cTitle)
   default cTitle to "Konfirmasi"

return (MessageBox(WVW_GETWINDOWHANDLE(), cMsg, cTitle, MB_YESNO + MB_ICONQUESTION + MB_SYSTEMMODAL) == IDYES)
