...
HB_FUNC( WVW_CXSETFONT )
{
   ...
   pData->s_lfCX.lfHeight         = ISNIL( 3 ) ? pWindowData->fontHeight - 2 : hb_parnl( 3 );
   pData->s_lfCX.lfWidth          = ISNIL( 4 ) ? pData->s_lfCX.lfWidth : hb_parni( 4 );
...
HB_FUNC( WVW_CXSTATUSFONT )
{
   ...
   BOOL  bFocus = ISNIL(3) ? TRUE : hb_parl(3);
