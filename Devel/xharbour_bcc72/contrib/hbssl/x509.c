/*
 * $Id: x509.c 10171 2016-12-11 13:08:42Z lculik $
 */
...
{
   PHB_X509 ph = ( PHB_X509 ) hb_parptrGC( X509_release, iParam );
...
{
   PHB_X509 ph = ( PHB_X509 ) hb_gcAlloc( sizeof( HB_X509 ), X509_release );
