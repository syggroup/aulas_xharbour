/*
 * $Id: wvtcore.c 10094 2015-02-11 21:30:05Z lculik $
 */
...
HB_FUNC( WVT_DRAWLABEL )
{
   ...
   logfont.lfCharSet        = ( BYTE ) ( ISNIL( 13 ) ? _s->CodePage : hb_parni( 13 ) );
...
HB_FUNC( WVT_CREATEFONT )
{
   ...
   logfont.lfCharSet        = ( BYTE ) ( ISNIL(  8 ) ? _s->CodePage : hb_parni( 8 ) );
   logfont.lfOutPrecision   = 0;
   logfont.lfClipPrecision  = 0;
...
HB_FUNC( WVT_LOADFONT )
{
   ...
   logfont.lfCharSet        = ( BYTE ) ( ISNIL(  9 ) ? _s->CodePage : hb_parni( 9 ) );
   logfont.lfOutPrecision   = 0;
   logfont.lfClipPrecision  = 0;
   logfont.lfQuality        = ( BYTE ) ( ISNIL( 10 ) ? DEFAULT_QUALITY : hb_parni( 10 ) );
   logfont.lfPitchAndFamily = FF_DONTCARE;
