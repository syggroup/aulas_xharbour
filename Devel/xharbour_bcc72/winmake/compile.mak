#===============================================================================
#
# $Id: compile.mak 10186 2017-02-15 02:05:35Z lculik $
#
# FILE  : compile.mak
...
$(HARBOUR_EXE_RC) : ChangeLog
	$(HBRC_EXE) $(HARBOUR_EXE_RC) "xHarbour Compiler" "harbour.exe" "1999-2017, http://www.xharbour.org/" "The xHarbour Team" "xHarbour Open Source" "resource/xhb.ico"

$(HARBOUR_DLL_RES) : $(HARBOUR_DLL_RC)
	$(RC_CMD)

$(HARBOUR_DLL_RC) : ChangeLog
	$(HBRC_EXE) $(HARBOUR_DLL_RC) "xHarbour Runtime" "xharbour.dll" "1999-2017, http://www.xharbour.org/" "The xHarbour Team" "xHarbour Open Source"
