/*
 * $Id: hbdoc.prg 10162 2016-10-04 13:05:35Z enricomaria $
 */
 ...
 * Date......: $Date: 2016-10-04 06:05:35 -0700 (Tue, 04 Oct 2016) $
 * Revision..: $Revision: 10162 $
 * Log file..: $Logfile:     $
 *
 *
...
//   LOCAL cCompiler     // Compiler type
   ...
   IF cLinkName = NIL
      MsgInfo( "xHarbour Doc Extractor"+ hb_osnewline() +;
      "Copyright 1999-2016, http://www.xharbour.org"+ hb_osnewline()+;
      ""+ hb_osnewline() +;
      "Syntax:  hbdoc [options] <linkname> [<ifile>]"+ hb_osnewline()+;
      ""+ hb_osnewline()+;
      "Options:  /txt Create an ASCII file instead of a Norton Guide"+ hb_osnewline()+;
      "          /con Create an ASCII file without formfeeds"+ hb_osnewline() +;
      "          /hpc Helpc source file"+ hb_osnewline() +;
      "          /ngi Adds the -NG switch to EHC command for compile for"+ hb_osnewline() +;
      "               DOS/Windows/Linux."+ hb_osnewline() +;
      "          /rtf Winhelp source code for Windows"+ hb_osnewline() +;
      "          /os2 OS/2 help source code For OS/2"+ hb_osnewline() +;
      "          /htm Generate HTML output"+ hb_osnewline() +;
      "          /ht2 Generate HTML output (new doc model)"+ hb_osnewline() +;
      "          /chm Generate HTML source files for Windows .CHM Help files"+ hb_osnewline() +;
      "          /ch2 Generate HTML source files for Windows .CHM Help files"+ hb_osnewline() +;
      "               (new doc model)"+ hb_osnewline() +;
      "          /pdf Generate an Adobe Portable Document (.PDF)"+ hb_osnewline() +;
      "          /trf Gerenate Linux TROFF code"+ hb_osnewline() +;
      "          /doc Create continuous ASCII file w/o author information"+ hb_osnewline() +;
      " "+ hb_osnewline() +;
      "Notes:  - Only one option can be specified at a time."+ hb_osnewline() +;
      "        - <linkname> is the name of the Norton Guide Link file."+ hb_osnewline()+;
      "        - <iFile> is a file containing a list of files to process"+ hb_osnewline() +;
      "          otherwise *.prg, *.c, *.asm, *.ch and *.txt are used."+ hb_osnewline() )
      RETURN NIL
   ENDIF
