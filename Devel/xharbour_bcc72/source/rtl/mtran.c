/*
 * $Id: mtran.c 10124 2015-05-09 20:37:40Z lculik $
 */
...
static char * hb_strMemotran( char * pszResult, HB_SIZE * ulResultLen, const char * pszString, HB_SIZE ulStringLen, char cHardcr, char cSoftcr )
{
   ...
   HB_TRACE( HB_TR_DEBUG, ( "hb_strMemotran(%s, %p, %s, %" HB_PFS "u, %x, %x)", pszResult, ulResultLen, pszString, ulStringLen, cHardcr, cSoftcr ) );
