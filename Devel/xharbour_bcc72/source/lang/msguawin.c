/*
 * $Id: msguawin.c 9279 2011-02-14 18:06:32Z druzus $
 */
...
{
   {
      ...
      "Недопустимі символи у імені аліаса",
      "Аліас вже використовується",
      "",
      "Помилка під час створення",
      "Помилка п_д час відкриття",
      "Помилка п_д час закриття",
      "Помилка п_д час читання",
      "Помилка п_д час запису",
      "Помилка п_д час друку",
      "",
      "",
      "",
      "",
      ...
      "hb_xrealloc викликано з NULL вказівником",
      "hb_xrealloc викликано з помилковим вказівником",
      "hb_xrealloc не може перерозподілити пам'ять",
      "hb_xfree викликано з помилковим вказівником",
      "hb_xfree викликано з NULL вказівником",
      ...
      "Вихід за межі стеку",
      "%s: спроба копіювати елемент на себе",
