...
{
   {
      ...
      "Недопустим╕ символи у ╕мен╕ ал╕аса",
      "Ал╕ас вже використову╜ться",
      "",
      ...
      "Потр╕бне блокування",
      "Запис заборонено",
      "Зб╕й блокування п╕д час додаванн╕ запису",
      ...
      "hb_xrealloc викликано з NULL вказ╕вником",
      "hb_xrealloc викликано з помилковим вказ╕вником",
      "hb_xrealloc не може перерозпод╕лити пам'ять",
      "hb_xfree викликано з Помилковим вказ╕вником",
      "hb_xfree викликано з NULL вказ╕вником",
      ...
      "Вих╕д за меж╕ стеку",
      "%s: спроба коп╕ювати елемент на себе",
      "%s: помилкове ╕м'я зм╕нно╓",
      "Переповнення буферу пам'яти",
